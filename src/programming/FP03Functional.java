...
public class FP03Functional {
	...
	private static int addListOfNumbersFunctional(List<Integer> numbers) {
		...
		// To reduce the sum into a single value , reduce operation is performed.
		// Terminal Operation
		// reduce() ; Under the hood , it takes the nums and performs an aggregate
		// operation .
		return numbers.stream()
				// .reduce(0,FP03Functional::sum);
				// .reduce(0,(x,y) -> x+y)
